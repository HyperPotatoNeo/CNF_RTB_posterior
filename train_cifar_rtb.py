...
parser.add_argument('--temperature', default=1.0, type=float, help='Temperature for classifier softmax')
...
rtb_model.finetune(shape=(args.batch_size, 3, 32, 32), n_iters = args.n_iters, wandb_track=args.wandb_track, learning_rate=args.lr, prior_sample=args.prior_sample, iw_logz=args.iw_logz, compute_fid=args.compute_fid)